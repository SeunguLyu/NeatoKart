...
class RecordData(Node):
    def __init__(self, image_topic):
        ...
        self.isImage = True
        self.image_name = "left 0 front 72.png"
        self.did_draw = False
    ...
    def run_loop(self):
        if not self.cv_image is None and not self.did_draw:
            ...
            for r in results:
                ...
                cv2.line(self.cv_image, ptA, ptB, (0, 255, 0), 1)
                cv2.line(self.cv_image, ptB, ptC, (0, 255, 0), 1)
                cv2.line(self.cv_image, ptC, ptD, (0, 255, 0), 1)
                cv2.line(self.cv_image, ptD, ptA, (0, 255, 0), 1)
